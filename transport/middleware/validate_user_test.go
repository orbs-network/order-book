...
func TestValidateUserMiddleware(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedBody:   "{\"status\":400,\"msg\":\"Invalid API key (ensure the format is 'Bearer YOUR-API-KEY')\"}\n",
		},
		{
		...
		},
		{
			...
			expectedBody:   "{\"status\":401,\"msg\":\"Unauthorized\"}\n",
		},
		{
			...
			expectedBody:   "{\"status\":500,\"msg\":\"Internal server error\"}\n",
		},
		{
